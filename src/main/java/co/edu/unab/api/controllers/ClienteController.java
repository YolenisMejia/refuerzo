...
public class ClienteController {
    ...
    public ArrayList<ClienteModel> clientePorNombre(@PathVariable("nombre") String nombre ){
        return clienteService.obtenerPorNombre(nombre.toLowerCase());
    }
    ...
    public ArrayList<ClienteModel> clientePorNombreYApellido(@PathVariable("nombre") String nombre, @PathVariable("apellido") String apellido ){
        return clienteService.obtenerPorNombreyApellido(nombre.toLowerCase(), apellido.toLowerCase());
    }
    ...
    @GetMapping(path="/puntosmenorigual/{puntos}")
    ...
    public ArrayList<ClienteModel> clientePorCiudad(@PathVariable("ciudad") String ciudad){
        return clienteService.obtenerClientePorCiudad(ciudad.toLowerCase());
    }
    ...
    public ArrayList<ClienteModel> clientePorAddress(@PathVariable("ciudad") String ciudad,@PathVariable("departamento") String departamento ){
        return clienteService.obtenerClientePorCiudadYDepartamento(ciudad.toLowerCase(),departamento.toLowerCase());
    }
